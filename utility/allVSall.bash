...
echo " * allVSallMain.cpp: Compiling . . ."
if ${CXX} ${CXXFLAGS} -c "allVSallMain.cpp"
then
   echo " * allVSallMain.cpp: Compilation succeeded."
else
   echo " * allVSallMain.cpp: Compilation failed."
   echo " * Build failed."
   rm *.o
   exit 7
fi
...
echo " * Linking . . ."
execFile="allVSallRunSim"
rm -f "${execFile}"
if ${CXX} ${LDLIBS} -o "${execFile}" "${challenge}Main.o" "${challenge}.o" "neuralNet.o" "evolution.o" "allVSallMain.o" ${objectFiles}
then
