...
if ${CXX} ${CXXFLAGS} -c "humanVSBotMain.cpp"
then
   echo " * humanVSBotMain.cpp: Compilation succeeded."
else
   echo " * humanVSBotMain.cpp: Compilation failed."
   echo " * Build failed."
   rm *.o
   exit 7
fi
...
echo " * Linking . . ."
execFile="humanVSBotRunSim"
rm -f "${execFile}"
if ${CXX} ${LDLIBS} -o "${execFile}" "${challenge}Main.o" "${challenge}.o" "neuralNet.o" "evolution.o" "humanVSBotMain.o" ${objectFiles}
then
   echo " * Linking succeeded."
   echo " * Executable file ./humanVSBotRunSim is ready to run!"
else
   echo " * Linking failed."
   echo " * Build failed."
   rm *.o
